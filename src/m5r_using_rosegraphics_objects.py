...
#            causes pixels to initialise on the screen
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            When you want to view graphics created, otherwise the window would just close automaticlly
#
